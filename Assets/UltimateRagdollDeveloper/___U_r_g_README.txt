...
Bug fixes
- reorganized content to streamline Unity 3.5 content distribution
...
- press the COMPILE button. A console warning log message will indicate when the procedure is completed.
