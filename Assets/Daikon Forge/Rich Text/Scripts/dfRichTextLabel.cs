...
public class dfRichTextLabel : dfControl, IDFMultiRender
{
	...
	public dfList<dfRenderData> RenderMultiple()
	{
		...
		UnityEngine.Profiling.Profiler.BeginSample( "Render " + this.name );
		try
		{
			...
			UnityEngine.Profiling.Profiler.BeginSample( "Gather markup render buffers" );
			buffers.Clear();
	...
	private void processMarkup()
	{
		...
		UnityEngine.Profiling.Profiler.BeginSample( "Perform layout on markup" );
	...
	private void clipToViewport( dfRenderData renderData )
	{
		...
		UnityEngine.Profiling.Profiler.BeginSample( "Clip markup box to viewport" );
