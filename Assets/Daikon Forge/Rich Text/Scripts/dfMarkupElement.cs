...
public abstract class dfMarkupElement
{
	...
	{
		UnityEngine.Profiling.Profiler.BeginSample( "Perform markup layout: " + this.GetType().Name );
...
public class dfMarkupString : dfMarkupElement
{
	...
	internal dfMarkupElement SplitWords()
	{
		...
		UnityEngine.Profiling.Profiler.BeginSample( "dfMarkupString.SplitWords()" );
